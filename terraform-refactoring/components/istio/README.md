...
| `istio-gateway` | `istio-gateway` | `1.28/<risk>` | Ingress gateway for north-south traffic |
...
| `istio_gateway` | `object` | `{}` | Configuration for `istio-gateway` (revision, units, trust, constraints, config, resources) |
...
|---|---|---|---|
| `istio_gateway_gateway` | `istio-gateway` | `gateway` | — |
