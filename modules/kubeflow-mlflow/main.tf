...
module "mlflow" {
  source = "git::https://github.com/canonical/charmed-mlflow-solutions//modules/mlflow?ref=main"
  ...
  existing_opentelemetry_collector_name = var.cos_configuration ? module.kubeflow.opentelemetry_collector_k8s.app_name : null
